exports.process = function (xmlObj) {
    ...
    if (results['moves'] && results['rotates']) {
        if (results['rotatesDegrees']) {
            ...
            results['html'] = 'Remember, a the pen must rotate exactly 60 degrees each time it moves in order to draw a hexagon!';
        }

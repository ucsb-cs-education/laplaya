...
CustomCommandBlockMorph.prototype.userMenu = function () {
    ...
    if (this.isPrototype) {
        ...
        if (this.receiver().parentThatIsA(IDE_Morph))
...
// StartingScriptsDialogMorph inherits from DialogBoxMorph:

StartingScriptsDialogMorph.prototype = new DialogBoxMorph();
StartingScriptsDialogMorph.prototype.constructor = StartingScriptsDialogMorph;
StartingScriptsDialogMorph.uber = DialogBoxMorph.prototype;

// StartingScriptsDialogMorph constants:

StartingScriptsDialogMorph.prototype.key = 'blockExport';
...
StartingScriptsDialogMorph.prototype.init = function (serializer, blocks, position) {
    ...
    StartingScriptsDialogMorph.uber.init.call(
        this,
        null, // target
        function () { myself.saveBlocks(); },//myself.exportBlocks(); },
        null // environment
    );
...
StartingScriptsDialogMorph.prototype.popUp = function (wrrld) {
    var world = wrrld || this.target.world();
    if (world) {
...
StartingScriptsDialogMorph.prototype.selectAll = function () {
    this.body.contents.children.forEach(function (checkBox) {
        if (!checkBox.state) {
            checkBox.trigger();
        }
...
StartingScriptsDialogMorph.prototype.selectNone = function () {
    this.blocks = [];
    this.body.contents.children.forEach(function (checkBox) {
        checkBox.refresh();
    });
...
StartingScriptsDialogMorph.prototype.fixLayout
    = BlockEditorMorph.prototype.fixLayout;

...
IDE_Morph.prototype.init = function (paramsDictionary) {
    ...
    this.log = [];
    //this.log.changes = [];
    IDE_Morph.prototype.logIndex = 0;
...
/* This function will break if other elements are added into the frameMorph. The idx that is returned counts all
   children of the frameMorph
 */
